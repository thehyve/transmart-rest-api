 ...
 *
 * @param links should be a collection of {@link Link} objects
 * @param embeddedEntities should be a collection of strings that indicate which other keys are embedded entities.
 */
@CompileStatic
